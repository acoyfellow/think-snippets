...
// Isolated personal-only deploy for the effect-hello example.
...
const app = await alchemy('think-effect-hello', { stage: STAGE });
const worker = await Worker('effect-hello', {
  entrypoint: 'worker.ts',
  compatibilityDate: '2026-05-21',
  compatibility: 'node',
  bindings: {
    AI: Ai(),
    Greeter: DurableObjectNamespace('Greeter', { className: 'Greeter', sqlite: true }),
