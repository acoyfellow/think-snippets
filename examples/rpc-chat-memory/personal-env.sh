#!/usr/bin/env bash
# Isolated copy of the personal-account safety rail for examples/rpc-chat-memory.
# Forces every Cloudflare-affecting command in this example onto the personal CF account.
set -euo pipefail
